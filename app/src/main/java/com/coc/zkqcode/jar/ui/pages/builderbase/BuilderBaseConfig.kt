    ...
    item {
        AnimatedVisibility(visible = isExpanded) {
            Column {
                ...
                AnimatedVisibility(visible = GlobalVars.configStates["${BUILDER_BASE_SETTINGS.NO_BUILDER_BASE.key}_c${index}"]?.value == "0") {
                    Column {
                        Row {
                            SettingCheckBox(
                        ...
                        AnimatedVisibility(visible = GlobalVars.configStates["${BUILDER_BASE_SETTINGS.NIGHT_BUILD_SETTING.key}_c${index}"]?.value == "1") {
