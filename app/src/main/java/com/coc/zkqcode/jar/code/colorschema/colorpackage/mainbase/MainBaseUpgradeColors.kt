...
object MainBaseUpgradeColors : IMainBaseUpgradeColors {
    ...
    override val MainBaseInsufficientResources = ColorSchema.parse(
        798, 594, 994, 668, "7F88FF", "1|0|7F88FF,2|0|7F88FF,3|0|7F88FF,3|1|7F88FF,2|1|7F88FF,0|1|7F88FF,0|1|7F88FF,0|2|7F88FF,1|2|7F88FF", 0, 0.97, "主世界升级资源不�?
    )
    ...
    override val GoblinWorker = ColorSchema.parse(
        550, 10, 853, 82, "37AB98", "-10|8|57D5CD,-20|0|3B9C8F,-20|-7|2C9098,-8|-12|155D68,-1|-17|48EED9,5|-18|4DFADA,7|-6|2C5A4E,13|-2|49DFC6,3|4|3CAA97", 0, 0.9, "哥布林工�?
    )
