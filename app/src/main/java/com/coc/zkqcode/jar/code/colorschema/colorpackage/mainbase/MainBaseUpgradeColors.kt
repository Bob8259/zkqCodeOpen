...
object MainBaseUpgradeColors : IMainBaseUpgradeColors {
    ...
    override val GoblinWorker: ColorSchema = ColorSchema.parse(
        452, 10, 853, 82, "37AB98", "-10|8|57D5CD,-20|0|3B9C8F,-20|-7|2C9098,-8|-12|155D68,-1|-17|48EED9,5|-18|4DFADA,7|-6|2C5A4E,13|-2|49DFC6,3|4|3CAA97", 0, 0.9, "哥布林工头"
    )
    override val GoblinWorker2: ColorSchema = ColorSchema.parse(
        395, 10, 654, 81, "16686C", "2|2|6E9EA4,-6|2|1A2432,-13|-5|207783,-7|-6|34AEAA,2|-11|49E7D2,3|-11|48E8D3,11|-11|42C4A9,14|-10|3EAE9D,11|-2|48DFD5", 0, 0.9, "哥布林工头2"
    )
}
