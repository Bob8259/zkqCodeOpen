...
object MyColors : IWorkerColors by WorkerColors, IUIColors by UIColors, IFeatureColors by FeatureColors,
    ...
    val InnerShopArrow: ColorSchema = ColorSchema.parse(
        ...
        363,
        "00A3FD",
        "9|0|00A2FD,18|0|01A0FF,27|0|08A7FF,36|0|13AEFF,0|25|02ABFF,9|25|01ABFE,18|25|01A6FD,27|25|04A1FF,36|25|0C9BFF",
        0,
        0.9,
        "商店内部箭头"
    )
    val WallInShop: ColorSchema = ColorSchema.parse(
        ...
        453,
        "EADEAC",
        "8|0|567188,16|0|5C96CD,24|0|7BDBF3,32|0|EADEAC,0|26|4F9371,8|26|325A47,16|26|47956C,24|26|57B688,32|26|63CD98",
        0,
        0.9,
        "商店内部城墙"
    )
