...
object MainBaseTutorial : IMainBaseTutorial {
    ...
    override val SpeakingVillager = ColorSchema.parse(
        277, 313, 674, 517, "FFFFFF", "56|-1|FFFFFF,157|-3|FFFFFF,252|-7|62ACDE,274|-3|68ACDD,275|20|85CFDD,275|101|6AAFE1,-30|108|66AEDE,-48|104|66AADE,-49|5|9EE3FF", 0, 0.9, "村民说话�?
    )
    override val SpeakingVillager2 = ColorSchema.parse(
        238, 295, 665, 516, "67AFDE", "10|-1|69B1DF,16|0|89B0D4,293|0|66AEDE,311|4|66AADD,294|162|FFFFFF,4|153|FFFFFF,-5|132|FFFFFF,-35|95|FFFFFF,-41|89|FFFFFF", 0, 0.9, "村民说话�?"
    )
    ...
    override val TutorialBuildClick = ColorSchema.parse(
        121, 60, 1155, 611, "FEFEFE", "3|5|FEFEFE,9|-2|FEFEFE,13|-8|FDFDFE,27|-2|2AF8A3,23|8|16BE4B,19|15|14B645,13|21|15BF53,-2|22|16C358,-14|15|14B645", 0, 0.93, "教程建造绿色箭�?
    )
    override val TutorialGoblinAttack = ColorSchema.parse(
        629, 548, 818, 617, "77F4D7", "34|-4|7FF7DC,74|-5|81F7DD,91|-4|7FF7DB,105|9|63EECA,113|29|1FBB6C,107|34|1EBB6D,47|37|1FBD71,14|33|1FBB6D,-3|28|1FBB6C", 0, 0.9, "教程哥布林进�?
    )
    override val VillagerAttack = ColorSchema.parse(
        364, 411, 572, 494, "7DF7DA", "32|-3|83F8DD,66|-4|85F8DF,99|-3|83F8DE,114|8|6BF2D0,109|35|1FBB6C,73|41|20BF73,35|37|1FBB6D,10|33|1FBB6C,-7|29|1FBC6D", 0, 0.9, "村民建议进攻哥布�?
    )
    ...
    override val AttackGoblin = ColorSchema.parse(
        349, 470, 520, 538, "53C7FF", "20|-4|54CAFF,44|-8|56CBFF,65|-7|55CBFF,77|-1|53C7FF,87|9|4ABDFF,87|22|145EF1,74|27|1256EE,37|36|1250EC,10|33|1251ED", 0, 0.9, "哥布林森�?
    )
    ...
    override val TutorialUpgradeTownHall = ColorSchema.parse(
        799, 578, 1003, 678, "89F6D4", "24|9|87F1CF,45|7|88F2D0,75|7|88F2D0,104|4|88F4D1,114|-2|89F8D5,107|48|48C997,87|46|48CA99,29|45|48CB99,10|42|49CD9C", 0, 0.9, "教程升级大本�?
    )
    ...
    override val UpgradeTHArrow = ColorSchema.parse(
        208, 38, 1053, 521, "1EAAFF", "28|26|07AEFF,41|29|07ACFF,61|14|0BAFFF,71|7|1CB6FF,56|1|029EFF,50|-18|11AAFF,45|-32|29B9FF,30|-27|22BAFF,27|-10|05A0FF", 0, 0.9, "升级大本�?
    )
}
