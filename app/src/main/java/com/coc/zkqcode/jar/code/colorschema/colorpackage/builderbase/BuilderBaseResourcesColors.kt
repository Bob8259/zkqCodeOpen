...
object BuilderBaseResourcesColors : IBuilderBaseResourcesColors {
    override val CannotCollectExilerCart = ColorSchema.parse(
        859, 569, 1024, 645, "D3D3D3", "28|3|D2D2D2,66|0|D3D3D3,82|4|D2D2D2,86|11|CDCDCD,87|30|ADADAD,78|39|ACACAC,45|36|ADADAD,18|34|ADADAD,-8|27|ADADAD", 0, 0.98, "无法收集圣水�?
    )
    override val CollectExilerCart = ColorSchema.parse(
        859, 569, 1024, 645, "8DEABE", "25|-3|8EEABF,65|-1|8EEABF,101|0|8DEABE,107|5|87E9BB,106|35|3AD48B,95|40|39CE87,64|37|3AD38A,13|31|3AD48B,-2|29|3AD48B", 0, 0.98, "收集圣水�?
    )
