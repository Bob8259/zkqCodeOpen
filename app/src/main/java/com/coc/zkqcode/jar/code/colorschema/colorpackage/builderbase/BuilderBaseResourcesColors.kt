...
object BuilderBaseResourcesColors : IBuilderBaseResourcesColors {
    ...
    override val BuilderBaseCollectGold1: ColorSchema = ColorSchema.parse(
    ...
    override val BuilderBaseCollectExiler1: ColorSchema = ColorSchema.parse(
    ...
    override val BuilderBaseCollectGem1: ColorSchema = ColorSchema.parse(
    ...
    override val BuilderBaseCollectGem2: ColorSchema = ColorSchema.parse(
