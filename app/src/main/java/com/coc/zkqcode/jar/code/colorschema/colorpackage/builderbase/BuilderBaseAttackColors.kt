...
object BuilderBaseAttackColors : IBuilderBaseAttackColors {
    override val BuilderBaseGold: ColorSchema = ColorSchema.parse(
    ...
    override val BuilderBaseExiler: ColorSchema = ColorSchema.parse(
    ...
    override val AttackNow: ColorSchema = ColorSchema.parse(
    ...
    override val TrainTroopsWarning: ColorSchema = ColorSchema.parse(
    ...
    override val CancelAttackSearch: ColorSchema = ColorSchema.parse(
    ...
    override val NightWitch: ColorSchema = ColorSchema.parse(
    ...
    override val TroopSkills: ColorSchema = ColorSchema.parse(
