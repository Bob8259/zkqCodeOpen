...
object MainBaseTraining : IMainBaseTraining {
    ...
    override val AttackInTrainingPage = ColorSchema.parse(
        1009, 615, 1252, 665, "7084A2", "13|-1|6F83A1,50|-2|6E82A0,80|-5|6D809E,110|-5|6D809E,125|1|7184A2,125|6|768AA8,125|20|8298B6,112|26|859BB9,26|22|8399B7", 0, 0.9, "训练部队内进�?
    )
    ...
    override val TrainArcher = ColorSchema.parse(
        18, 416, 1275, 710, "663BAD", "3|14|7D98F3,-21|18|758BDE,-33|9|7D81C0,-54|-13|E37AFB,-51|-25|C563EC,-39|-39|BD5EF9,-23|-32|9149D9,-9|-24|733AC8,8|-15|7739D5", 0, 0.9, "训练弓箭�?
    )
    override val TrainBarbarian = ColorSchema.parse(
        18, 416, 1275, 710, "37527E", "-18|-9|677DA8,-23|-27|53BAD8,-17|-43|44B5E1,-3|-44|3EB8F5,6|-32|47CAFF,9|-12|6FAAFF,0|2|357FAC,12|8|3F4D82,30|5|6EF3FF", 0, 0.9, "训练野蛮�?
    )
    override val GrayBarbarian = ColorSchema.parse(
        24, 430, 695, 690, "A9A9A9", "9|11|CDCDCD,30|11|D3D3D3,33|5|D2D2D2,27|-10|B8B8B8,27|-22|C3C3C3,18|-30|C3C3C3,8|-30|BEBEBE,-7|-32|B5B5B5,-18|-30|C1C1C1", 0, 0.9, "已练�?
    )
