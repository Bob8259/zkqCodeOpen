...
object BuilderBaseUpgradeColors : IBuilderBaseUpgradeColors {
    ...
    override val BuilderBaseWallInShop: ColorSchema = ColorSchema.parse(
        146, 404, 1238, 449, "2B3756", "3|0|5086B6,6|0|4C76A3,8|0|6197CB,11|0|65A4DC,0|11|252E47,3|11|252E48,6|11|263A57,8|11|2E466C,11|11|3B5D88", 0, 0.9, "商店内部城墙"
    )
