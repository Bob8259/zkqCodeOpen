...
object UIColors : IUIColors {
    override val Reconnection = ColorSchema.parse(
        240, 195, 1030, 530, "1B1B1C", "106|-4|1B1B1C,184|8|1B1B1C,142|-121|1B1B1C,236|-139|1B1B1C,302|-142|1B1B1C,442|-13|1B1B1C,541|-48|1B1B1C,539|-91|1B1B1C,523|-135|1B1B1C", 0, 0.9, "重连1"
    )
    ...
    override val CancelEditMode = ColorSchema.parse(
        1051, 484, 1269, 537, "817CFF", "26|2|7D78FF,50|1|7F7AFF,75|1|7F7AFF,85|24|1712E6,64|29|1511DA,40|29|1511DA,-68|9|FFFFFF,-76|15|FFFEF9,-71|27|1611DF", 0, 0.9, "取消编辑模式"
    )
