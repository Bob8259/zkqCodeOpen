...
object NightBaseBuildings {
    // 资源与核心建筑
    val BUILDER_HALL = SettingDef("builder_hall", "建筑大师大本营", 1, "NIGHT_BASE_SETTINGS")
    ...
    val NIGHT_ARCHER_TOWER = SettingDef("night_archer_tower", "箭塔", 1, "NIGHT_BASE_SETTINGS")
...
object NightBaseBuildingsPriority {
    // 资源与核心建筑
    val BUILDER_HALL_PRIORITY = SettingDef("builder_hall_priority", "建筑大师大本营", 1, "NIGHT_BASE_SETTINGS_PRIORITY")
    ...
    val BUILDER_BARRACKS_PRIORITY =
        SettingDef("builder_barracks_priority", "建筑大师训练营", 7, "NIGHT_BASE_SETTINGS_PRIORITY")
    ...
    val NIGHT_ARCHER_TOWER_PRIORITY =
        SettingDef("night_archer_tower_priority", "箭塔", 11, "NIGHT_BASE_SETTINGS_PRIORITY")
