...
object BuilderBaseTutorial : IBuilderBaseTutorial {
    ...
    override val UpgradeBuilderBaseTH: ColorSchema = ColorSchema.parse(
    ...
    override val TutorialBuilderBaseBarb: ColorSchema = ColorSchema.parse(
    ...
    override val BuilderBaseAttack: ColorSchema = ColorSchema.parse(
    ...
    override val BuilderBaseDeployBarbs: ColorSchema = ColorSchema.parse(
    ...
    override val UpgradeStarLab: ColorSchema = ColorSchema.parse(
