...
object BuilderBaseTutorial : IBuilderBaseTutorial {
    ...
    override val UpgradeBarbarian = ColorSchema.parse(
        943, 617, 1045, 651, "FFFFFF", "21|0|FFFFFF,41|0|E4F8F4,61|0|ED2773,82|0|FF67C4,0|17|21CE8C,21|17|21CD8B,41|17|20CC8A,61|17|20C882,82|17|0D0D0D", 0, 0.9, "升级野蛮�?
    )
    ...
    override val BuilderBaseAttack = ColorSchema.parse(
        33, 580, 133, 689, "99867C", "10|10|456C8F,28|0|9D8B80,36|8|968276,19|17|547D9F,23|24|406485,6|25|406382,-13|3|A29188,-4|-1|9D8A80,34|3|9A867C", 0, 0.9, "夜教程进�?
    )
    override val BuilderBaseDeployBarbs = ColorSchema.parse(
        97, 574, 193, 616, "FF763A", "-7|6|FF773A,-12|0|FF763A,-5|-1|FF763A,3|-1|FF763A,5|4|FF793C,12|6|FF7C3F,16|4|FF7A3E,18|3|FF7A3D,20|-3|FF763A", 0, 0.9, "部署野蛮�?
    )
    override val UpgradeStarLab = ColorSchema.parse(
        196, 35, 976, 410, "20B7FF", "4|34|05ADFF,2|53|15ADFF,50|54|25C3FF,53|21|0AA0FF,77|2|4FA9FF,58|-23|4EAAFF,42|-22|2BA3FF,26|22|00A6FD,40|12|06A6FF", 0, 0.9, "升级星空实验�?
    )
}
