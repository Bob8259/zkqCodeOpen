...
object Schema {
    ...
    val MAIN_BASE_SETTINGS = listOf(
        ...
        SettingDef("spell_setting", "下法术", 1, "MAIN_BASE_SETTINGS"),
        SettingDef("reinforcement_setting", "下援兵", 1, "MAIN_BASE_SETTINGS"),
        SettingDef(
        ...
        SettingDef("manual_training", "手动练兵", 0, "MAIN_BASE_SETTINGS"),
        SettingDef("tactics_mode", "战术设置", "0", "MAIN_BASE_SETTINGS"),
        SettingDef("donation_setting", "自动捐兵", 1, "MAIN_BASE_SETTINGS"),
        SettingDef("request_reinforcement_setting", "请求增援", 1, "MAIN_BASE_SETTINGS"),
        SettingDef("donation_times", "捐兵轮数", 1, "MAIN_BASE_SETTINGS"),
        SettingDef("research_setting", "自动研究", 1, "MAIN_BASE_SETTINGS"),
        ...
        SettingDef("upgrade_pets", "升级战宠", 1, "MAIN_BASE_SETTINGS"),
        ...
        SettingDef("helper_settings", "用帮手", 1, "MAIN_BASE_SETTINGS"),
