...
object SchemaRegistry {
    val ALL_MODULES = listOf(
        ...
        ConfigModule("MAIN_BASE_TROOPS_AND_SPELLS", Scope.PROFILE, Schema.MAIN_BASE_TROOPS_AND_SPELLS.all),
        ...
        ConfigModule("MAIN_BASE_BUILDING_PRIORITIES", Scope.PROFILE, Schema.MAIN_BASE_BUILDING_PRIORITIES.all)
    )
}
